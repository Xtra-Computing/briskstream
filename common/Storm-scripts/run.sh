...
# echo 3 | sudo tee /proc/sys/vm/drop_caches
		argument="application：$3 num_socket: $4 num_cpu: $5 hz: $2 total threads: $6"
		# echo $argument
		arg_benchmark="--THz $2 --runtime 200  --loop 1000 --num_socket $4 --num_cpu $5"
...
app_cnt=0
cnt=0
for app in "WordCount"  #"FraudDetection" "SpikeDetection" "LogProcessing" "LinearRoad" #"StreamingAnalysis" "WordCount" "FraudDetection" "SpikeDetection" "LogProcessing" "VoIPSTREAM" "LinearRoad" 
do
    machine=1
