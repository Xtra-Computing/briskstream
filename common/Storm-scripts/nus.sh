...
# echo 3 | sudo tee /proc/sys/vm/drop_caches
		...
		arg_application="-st 5 -sit 10 -tt $6 -input $input -bt $bt --native -m remote  --microbenchmark" # --tune  --random  --worst
...
# echo 3 | sudo tee /proc/sys/vm/drop_caches
		...
		arg_application="-st 2 -sit 8 -tt $tt -input $input -bt $bt --native -m remote -a $app -mp $outputPath/native/$hz" # --tune  --random  --worst
