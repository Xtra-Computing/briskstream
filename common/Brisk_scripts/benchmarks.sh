...
for benchmark in "Write_Intensive" "Read_Write_Mixture" "CrossTables" "OnlineBiding" # "Write_Intensive" "Read_Write_Mixture" #"CrossTables" "OnlineBiding" #"Partition" "MultiPartition" #"Interval" "CrossTablesBreakdown" "Read_Only_Breakdown" "Write_Intensive_Breakdown" "Working_Set_Size_Breakdown" "Read_Write_Mixture_Breakdown"
do
    app="MicroBenchmark"
    machine=3 #RTM.
        ...
        case "$benchmark" in
            "Read_Only")
                ...
                do
                    for theta in 0
                    do
                        for tt in 38 #24 8 #38 32 24 16 8 2
                        do
                        ...
                        do
                            ...
                            do
                                ...
                                do
                                    ...
                                    do
                                        TP=$tt
                                        for checkpoint in 0.05 #0.025 0.05 0.1 0.25 0.5 0.75 1
                                        do
                                            ratio_of_multi_partition=1
                                            number_partitions=4
                        ...
                        do
                            ...
                            do
                                ...
                                do
                                    for ratio_of_read in 1
                                    do
                                        for checkpoint in 0.05 #0.05 0.1 0.25 0.5 0.75
                                        do
                                            TP=$tt
