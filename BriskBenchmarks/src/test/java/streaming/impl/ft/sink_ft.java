 ...
 */
public class sink_ft extends MapBolt implements Checkpointable {
    private final static Logger LOG = LoggerFactory.getLogger(sink_ft.class);
    private static final long serialVersionUID = 6671299264977139136L;
