...
public class LREvent extends TxnEvent {
    ...
    private PositionReport report;//event associated meta data.
     ...
     * @param numAccess
     */
    public LREvent(int[] keys, boolean flag, int numAccess, long bid
     ...
     * @param key_array
     */
    public LREvent(int bid, int pid, String bid_array, int num_of_partition,
