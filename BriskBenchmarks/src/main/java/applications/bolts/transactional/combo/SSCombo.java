package applications.bolts.transactional.combo;

import applications.bolts.transactional.gs.*;
import applications.bolts.transactional.ss.SSBolt_sstore;
...
public class SSCombo extends SPOUTCombo {
    private static final Logger LOG = LoggerFactory.getLogger(SSCombo.class);
