...
public class DataSource extends AbstractSpout {
    ...
    int count = 0;
    private applications.general.spout.helper.DataSource dataSource;
//    private ReceiveParser parser;
    ...
    public void initialize(int thread_Id, int thisTaskId, ExecutionGraph graph) {
        ...
        dataSource = new applications.general.spout.helper.DataSource(Wrapper, skew, false, tuple_size, false);
