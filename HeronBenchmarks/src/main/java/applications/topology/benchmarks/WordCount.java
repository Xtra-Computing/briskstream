...
public class WordCount extends BasicTopology {
    ...
    public StormTopology buildTopology() {
        ...
        builder.setBolt(Component.PARSER, new ParserBolt(parser, new Fields(Field.WORD))
                , config.getInt(WordCountConstants.Conf.PARSER_THREADS, 1)).shuffleGrouping(Component.SPOUT);

        builder.setBolt(Component.SPLITTER, new SplitSentenceBolt(), config.getInt(WordCountConstants.Conf.SPLITTER_THREADS, 1))
