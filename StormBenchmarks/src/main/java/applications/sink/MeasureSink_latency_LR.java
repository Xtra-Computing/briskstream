...
//                + String.valueOf(config.getInt("ct2"))
        ...
        String Plan_Path = System.getProperty("user.home") + OsUtils.OS_wrapper("Documents")
                + OsUtils.OS_wrapper("briskstream") + OsUtils.OS_wrapper("PLAN") + OsUtils.OS_wrapper("Storm");
        directory = Plan_Path
