...
//        initilize_parser();
    ...
    public StormTopology buildTopology() {
        ...
        spout.setFields(new Fields(WordCountConstants.Field.TEXT, MSG_ID, SYSTEMTIMESTAMP));

        builder.setSpout(Component.SPOUT, spout, spoutThreads);

        builder.setBolt(Component.PARSER, new ParserBolt_latency(parser
                        , new Fields(Field.IP, Field.TIMESTAMP, Field.TIMESTAMP_MINUTES, Field.REQUEST, Field.RESPONSE, Field.BYTE_SIZE, MSG_ID, SYSTEMTIMESTAMP)
                )
