...
/**
 * General purpose Brisk.execution.runtime.tuple consisting list of primitive types. Implements WritableComparable
 *
 * @author pranab
 */
public class Tuple implements WritableComparable<Tuple> {
	...
	public void add(byte type, String field) {
		...
		if (type == BYTE) {
			...
			try {
				...
				throw new IllegalArgumentException("Failed adding element to Brisk.execution.runtime.tuple, unknown element type");
			}
		} else {
			throw new IllegalArgumentException("Failed adding element to Brisk.execution.runtime.tuple, unknown element type");
		}
	...
	/* (non-Javadoc)
	 * @see org.apache.hadoop.disk.Writable#readFields(java.disk.DataInput)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.apache.hadoop.disk.Writable#write(java.disk.DataOutput)
	 */
	@Override
	public void write(DataOutput out) throws IOException {
		...
		for (Object field : fields) {
			if (field instanceof Byte) {
				...
				throw new IllegalArgumentException("Failed encoding, unknown element type in Brisk.execution.runtime.tuple");
			}
		}
	}
		...
		if (fields.size() == that.fields.size()) {
			for (int i = 0; i < fields.size() && compared == 0; ++i) {
				...
				if (field instanceof Byte) {
					...
					throw new IllegalArgumentException("Failed in compare, unknown element type in Brisk.execution.runtime.tuple  ");
				}
			}
		} else {
	...
	/**
	 * creates Brisk.execution.runtime.tuple based on partial list of source Brisk.execution.runtime.tuple
	 *
	 * @param start
	 * @param end
	 * @return
