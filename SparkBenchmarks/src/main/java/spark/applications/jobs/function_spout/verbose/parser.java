...
import applications.common.spout.helper.wrapper.verbose.ReceiveParser;
...
public class parser implements FlatMapFunction<Tuple2<String, String>, Event_MB> {
    private static final Logger LOG = LogManager.getLogger(spark.applications.jobs.function_spout.verbose.parser.class);
    ...
    public Iterator<Event_MB> call(Tuple2<String, String> msg) throws Exception {
        ...
        final List<StreamValues> parse = parser.parse(msg._2(), receive_time);
