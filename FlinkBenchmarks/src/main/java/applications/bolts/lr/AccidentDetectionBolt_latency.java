 ...
 * @author mjsax
 */
public class AccidentDetectionBolt_latency extends AbstractBolt {
    private static final long serialVersionUID = 5537727428628598519L;
    private static final Logger LOGGER = LoggerFactory.getLogger(AccidentDetectionBolt_latency.class);
    /**
...
//            cnt1++;
            this.collector.emit(ACCIDENTS_STREAM_ID,
                    new AccidentTuple(inputPositionReport_cp, new Short(minute), msgId, SYSStamp));
        }
...
//        if (stat != null) stat.end_measure();
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream(ACCIDENTS_STREAM_ID, AccidentTuple.getSchema_latency());
    }
